...
CI uploads the generated zip and checksum as a short-lived GitHub Actions artifact after the deterministic tests and package step pass. This is a testing convenience, not a signed or notarized release channel.
